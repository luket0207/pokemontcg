    ...
    <div className="game">
      ...
      {!forcedReplacePlayer && !isBetweenTurns && isAttacking && (
        <div className="attack-panel">
          ...
          />
          <Button type="secondary" onClick={() => setIsAttacking(false)}>Cancel</Button>
        </div>
      )}
      ...
      {!forcedReplacePlayer && !isBetweenTurns && isHealing && (
        <div className="heal-panel">
          ...
          />
          <Button type="secondary" onClick={() => setIsHealing(false)}>Cancel</Button>
        </div>
      )}
      ...
      {!forcedReplacePlayer && !isBetweenTurns && isAddingMaxHealth && (
        <div className="add-health-panel">
          ...
          />
          <Button type="secondary" onClick={() => setIsAddingMaxHealth(false)}>Cancel</Button>
        </div>
      )}
          ...
          <>
            ...
            {isChoosingStatusTarget && (
              <div className="choose-effect-target">
                ...
                <Button onClick={() => applyEffect("yours")}>
                  Your Pokémon
                </Button>
                ...
                <Button type="secondary" onClick={() => setIsChoosingStatusTarget(false)}>
                  Cancel
                </Button>
              </div>
            )}

            {!playerNeedsPokemon && !isChoosingStatusTarget && (
              <Actions
                onHeal={handleHeal}
